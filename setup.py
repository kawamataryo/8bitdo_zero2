...
setuptools.setup(
    ...
    url="https://github.com/kawamataryo/8bitdo-zero2",
    keywords=["8bitdo", "raspberry Pi"],
    project_urls={
        "Homepage": "https://github.com/kawamataryo/8bitdo-zero2",
        "Bug Tracker": "https://github.com/kawamataryo/8bitdo-zero2/issues",
    },
    classifiers=[
